...
let channels: Channel[] = [
  {
    ...
    name: "general-lounge",
    type: "public_group",
    description: "Welcome! Add contacts using their email address to start chatting.",
    icon: "💬",
    createdBy: "system",
    members: ["user_kasun"],
  ...
  "general-lounge": [
    {
      ...
      content: "Welcome to WhatsApp! Tap '+' or 'Google' button to add your friends by Email address and chat in real-time.",
